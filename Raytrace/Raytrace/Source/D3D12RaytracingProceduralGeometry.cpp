...
void D3D12RaytracingProceduralGeometry::OnInit() {
    ...
    //Framework::ImGuiManager::getInstance()->init(Win32Application::GetHwnd(), m_deviceResources->GetD3DDevice(), m_deviceResources->GetBackBufferFormat());
}
...
void D3D12RaytracingProceduralGeometry::OnUpdate() {
    ...
    //ImGui::Checkbox("Animate Geometry", &m_animateGeometry);
...
void D3D12RaytracingProceduralGeometry::OnRender() {
    ...
    //// Begin frame.
    //m_deviceResources->Prepare(D3D12_RESOURCE_STATES::D3D12_RESOURCE_STATE_PRESENT);
    //for (auto& gpuTimer : m_gpuTimers) {
    ...
    ////Framework::ImGuiManager::getInstance()->endFrame(m_deviceResources->GetCommandList());
